...
class AppController extends Controller
{
                    ...
                    if($layananAktif->COMMAND == "/daftar") {
                        ...
                        if($message == "/selesai") {
                            ...
                            if($message == $layanan->PIN) {
                                ...
                                file_get_contents($path.'/sendmessage?chat_id='.$chatId.'&text=PIN yang anda masukkan salah, coba lagi. Masukkan perintah /batal untuk membatalkan perintah&parse_mode=HTML');
                    ...
                    if(in_array($message, $command)) {
                        ...
                        if($message == "/daftar") {
                            ...
                            if(!$list_id) {
                                ...
                                file_get_contents($path.'/sendmessage?chat_id='.$chatId.'&text=Masukkan PIN anda untuk mengkonfirmasi pendaftaran akun. Masukkan perintah /batal untuk membatalkan perintah&parse_mode=HTML');

                            } else {

                                file_get_contents($path.'/sendmessage?chat_id='.$chatId.'&text=Tidak dapat mendaftarkan akun. Saat ini akun telegram anda sudah didaftarkan dengan username: <strong>' . $list_id->USERNAME . '</strong>, jika username anda tidak sesuai, segera hubungi divisi INS&parse_mode=HTML');
                        ...
                        if($message == "/selesai") {
                            ...
                            if($message == $layanan->PIN) {
                                ...
                                $this->sendMessage([
                                    "chat_id" => $chatId,
                                    "parse_mode" => "HTML"
                                ],  "Akun anda berhasil didaftarkan untuk menerima notifikasi");
                        ...
                        if($message == "/daftar") {
                            ...
                            if(!$list_id) {
                                ...
                                $this->sendMessage([
                                    "chat_id" => $chatId,
                                    "parse_mode" => "HTML"
                                ], "Masukkan PIN anda untuk mengkonfirmasi pendaftaran akun. Masukkan perintah /batal untuk membatalkan perintah", $markupKeyboard);
    ...
    public function test()
    {
        ...
        $reply = json_encode($replyKeyboard);
    }
}
